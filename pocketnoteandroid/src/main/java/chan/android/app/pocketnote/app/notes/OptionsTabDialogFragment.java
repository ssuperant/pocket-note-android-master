...
public class OptionsTabDialogFragment extends DialogFragment {
  ...
  private static final Option[] VIEW_OPTIONS = new Option[]{
    new Option(R.drawable.ic_action_collections_view_as_list, "列表视图"),
    new Option(R.drawable.ic_action_collections_view_as_grid, "网格视图")
  };
  private static final Option[] SORT_OPTIONS = new Option[]{
    new Option(R.drawable.ic_action_clock, "按修改时间"),
    new Option(R.drawable.ic_action_alphabetical_sorting, "按字母"),
    new Option(R.drawable.ic_action_color_pencil, "按颜色")
  };
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    tabs.setup();
    TabHost.TabSpec spec = tabs.newTabSpec("标签1");
