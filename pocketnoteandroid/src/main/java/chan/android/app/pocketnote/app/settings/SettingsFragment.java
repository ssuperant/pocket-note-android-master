...
public class SettingsFragment extends SherlockFragment {
  ...
  static {
    PHOTO_ACTIONS.add(new ActionListDialogFragment.Item(R.drawable.ic_action_device_access_camera, "拍照"));
    PHOTO_ACTIONS.add(new ActionListDialogFragment.Item(R.drawable.ic_action_content_picture, "从相册选择"));
  }
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    relativeLayoutPhoto.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        ActionListDialogFragment d = ActionListDialogFragment.newInstance("更换头像", PHOTO_ACTIONS);
        d.setPickItemListener(new ActionListDialogFragment.OnPickItemListener() {
          @Override
          public void onPick(int index) {
            if (PHOTO_ACTIONS.get(index).getName().equals("拍照")) {
    ...
    relativeLayoutName.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        d.setOnChangeNameListener(new ChangeNameDialogFragment.OnChangeNameListener() {
          ...
          @Override
          public void onReset() {
            AppPreferences.saveUserName("匿名用户");
            d.dismiss();
            textViewUserName.setText(AppPreferences.getUserName());
          }
        });
